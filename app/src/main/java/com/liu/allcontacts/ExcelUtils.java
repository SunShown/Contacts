...
//              sheet.mergeCells()
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ContactInfo list = (ContactInfo) objList.get(j);
                    sheet.addCell(new Label(0, j + 1, list.getId(),arial12format));
                    sheet.addCell(new Label(1, j + 1, list.getName(),arial12format));
                    sheet.addCell(new Label(2, j + 1, list.getPhone(),arial12format));
                    sheet.setColumnView(2,list.getPhone().length()+5);
